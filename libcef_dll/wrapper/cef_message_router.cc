...
class CefMessageRouterBrowserSideImpl : public CefMessageRouterBrowserSide {
 public:
  ...
  //Coderleex    重写这个函数可以监听CefQuery
  // 可以参考binging.html
  //************************************
  // Method:    OnProcessMessageReceived
  // FullName:  CefMessageRouterBrowserSideImpl::OnProcessMessageReceived
  // Access:    public 
  // Returns:   bool
  // Qualifier:
  // Parameter: CefRefPtr<CefBrowser> browser
  // Parameter: CefRefPtr<CefFrame> frame
  // Parameter: CefProcessId source_process
  // Parameter: CefRefPtr<CefProcessMessage> message
  //************************************
